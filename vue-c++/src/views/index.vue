  ...
  <div class="app-container home">
    <el-row :gutter="20">
      ...
      <el-col :span="24" style="margin-bottom:20px">
        <el-row :gutter="12">
          <el-col :xs="12" :sm="8" :md="4" v-for="c in statCards" :key="c.label" style="margin-bottom:10px">
            <el-card shadow="hover" :body-style="{padding:'14px 16px'}">
              <div style="font-size:11px;color:#909399;margin-bottom:4px">{{ c.label }}</div>
              <div style="font-size:22px;font-weight:700" :style="{color: c.color || '#303133'}">{{ c.value }}</div>
            </el-card>
          </el-col>
        </el-row>
      </el-col>
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>若依后台管理框架 <el-tag type="danger" size="mini" style="margin-left:6px">C++ Edition</el-tag></h2>
        <p>
        ...
        <el-row>
          <el-col :span="6">
            ...
            <ul>
              <li>Drogon C++</li>
              <li>JWT（自实现）</li>
              <li>libpq PostgreSQL</li>
              <li>SQLite 回退</li>
              <li>OpenSSL PBKDF2</li>
              <li>WebSocket</li>
              <li>...</li>
            </ul>
          </el-col>
