...
public:
    ...
    // ����������֤����ȡ userId ���ֶΣ�
    static jwt::decoded_jwt<jwt_traits> decode(const std::string &token) {
        return jwt::decode<jwt_traits>(token);
    }
};
